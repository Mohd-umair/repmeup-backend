  ...
  try {
    ...
    const diagnostics = {
      ...
      settings: {
        ...
        replyDelayMode: organization.autoReplySettings.replyDelayMode,
        humanDelayMinMinutes: organization.autoReplySettings.humanDelayMinMinutes,
        humanDelayMaxMinutes: organization.autoReplySettings.humanDelayMaxMinutes,
